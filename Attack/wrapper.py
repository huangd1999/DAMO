...
class MultiAttack(Attack):
    ...
    def forward(self, images, labels):
        ...
        diff_phase_img = [images.clone().detach().to(self.device)  for i in range(4)]
        ...
        for idx, attack in enumerate(self.attacks):
            ...
            # per_attack_record.append(corrects.sum().item())
            wrongs = ~corrects
            ...
            diff_phase_img[idx] = final_images.clone()
